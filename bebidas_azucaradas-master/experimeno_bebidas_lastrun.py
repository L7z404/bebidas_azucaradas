...
path2= r'C:\Users\Invitad@\Desktop\bebidas_azucaradas-master\bebidas_preguntas'
list_of_images = []
testcosaimg=[]
list_of_images2 = []
...
for thisImgse in imgse:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if imagen.status == STARTED:
            ...
            if tThisFlipGlobal > imagen.tStartRefresh + 2.5-frameTolerance:
        ...
        # *cruz* updates
        if cruz.status == NOT_STARTED and tThisFlip >= 2.5-frameTolerance:
            # keep track of start time/frame for later
